...
class ReleaseListTest extends TestCase
{
    ...
    public function testGetVersions()
    {
        ...
        $this->assertSame(
            $versions['7.2.0'],
            ['version' => "7.2.0", 'announcement' => "https://php.net/releases/7_2_0.php", 'date' => "30 Nov 2017", 'filename' => "php-7.2.0.tar.bz2", 'name' => "PHP 7.2.0 (tar.bz2)", 'sha256' => "2bfefae4226b9b97879c9d33078e50bdb5c17f45ff6e255951062a529720c64a", 'museum' => false]
        );
    }

    public function versionDataProvider()
    {
        return [["7.3", "7.3.0"], ["7.2", "7.2.13"], ["5.4", "5.4.45"], ["5.6", "5.6.39"]];
    }
